"""
Logistic regression on choice and reward history for the foraging task with addition of sliding window averaging and fit functions

adapted from https://github.com/AllenNeuralDynamics/aind-dynamic-foraging-models.git
"""
